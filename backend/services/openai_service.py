...
For MEAL entries:
{
  ...
  "vitamin_a_mcg": number (max 1 decimal - micrograms RAE, estimate based on typical content),
  "vitamin_c_mg": number (max 1 decimal - milligrams, estimate based on typical content),
  "vitamin_d_mcg": number (max 1 decimal - micrograms, estimate based on typical content),
  "vitamin_b12_mcg": number (max 1 decimal - micrograms, estimate based on typical content),
  "iron_mg": number (max 1 decimal - milligrams, estimate based on typical content),
  "calcium_mg": number (max 1 decimal - milligrams, estimate based on typical content),
  "potassium_mg": number (max 1 decimal - milligrams, estimate based on typical content),
  "magnesium_mg": number (max 1 decimal - milligrams, estimate based on typical content),
